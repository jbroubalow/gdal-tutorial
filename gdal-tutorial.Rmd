...
5. Upload the `.zip` folder containing your new shapefile to RStudio. RStudio will automatically extract the `.shp` file and the other necessary files. Also upload to RStudio the the folder containing the census data.
